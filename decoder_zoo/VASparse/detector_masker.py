...
def mask_and_save_boxes(
    ...
    # global_entity_dict[entity]['masked_image'] = None
    ...
    for entity, box, norm_box in zip(phrases, xyxy, normed_xyxy):
        ...
        global_entity_dict[entity]['masked_image'] = masked_image
...
class Detector:
    ...
    def detect_objects(self, sample: Dict):
        ...
        for entity_str in extracted_entities:
            ...
            global_entity_dict = mask_and_save_boxes(

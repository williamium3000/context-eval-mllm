...
"""Based on the given image, context, and the conversation history, please ask a follow-up question about the model's last response.

**Purpose:** Follow-up questions can be asked after ANY type of question (regular, adversarial, or unanswerable) to:
...
You should ask the question as if you are having a conversation with the model. The follow-up should flow naturally with the conversation history.

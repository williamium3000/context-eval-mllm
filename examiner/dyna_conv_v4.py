...
```json
[
    "object_id_1", # the most relevant object node to the context
    "object_id_2", # the second most relevant object node to the context
    "object_id_3", # the third most relevant object node to the context
    ...
]
```
"""

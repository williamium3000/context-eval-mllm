...
"""Now complete the third step. Please ask the unanswerable question about the attribute or relation of the generated hallucinated object and the corresponding ground-truth answer.
You should ask a question as if you are having a conversation with the model. Please respond in the above format with the generated question and ground-truth answer ONLY. DO NOT respond with anything else.
"""

...
python examiners/dyna_conv.py --model_path Salesforce/blip2-flan-t5-xl --dataset vg --p_mode CONV_MODEL_PERSPECTIVE_PROMPT_VG_SIMGPLE_INTERROGATEV2_NO_COVERAGE --outfile output/vg/dyna/test_2.json

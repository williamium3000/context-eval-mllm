...
python examiners/dyna_conv.py --model_path llava-hf/llava-1.5-7b-hf --dataset vg --p_mode CONV_MODEL_PERSPECTIVE_PROMPT_VG_SIMGPLE_INTERROGATEV2_NO_COVERAGE --outfile output/vg/dyna/test.json

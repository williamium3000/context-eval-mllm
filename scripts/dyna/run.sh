...
python examiners/dyna_conv.py --dataset vg --p_mode CONV_MODEL_PERSPECTIVE_PROMPT_VG_SIMGPLE_INTERROGATE --outfile output/vg/dyna/CONV_MODEL_PERSPECTIVE_PROMPT_VG_SIMGPLE_INTERROGATE.json
